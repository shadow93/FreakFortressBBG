...
public Action:OnSetupTime(Handle:event, const String:name[], bool:dontBroadcast)
{
	...
	{
		case 1: // Bosses that sponsor either team
		{
			switch(GetRandomInt(0,1))
			{
				case 0: // BLU Boss
...
EquipBoss(boss)
{
	...
	new String:weapon[64], String:attributes[256];
	for(new i=1; ; i++)
	{
		KvRewind(BossKV[Special[boss]]);
...
public Action:OnDestroy(Handle:event, const String:name[], bool:dontBroadcast)
{
	if(Enabled)
	{
...
public Action:OnUberDeploy(Handle:event, const String:name[], bool:dontBroadcast)
{
...
HelpPanelBoss(boss)
{
	...
	new String:text[9000], String:language[20];
