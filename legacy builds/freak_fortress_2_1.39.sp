...
stock FindVersionData(Handle:panel, versionIndex)
{
    switch(versionIndex)
    {
        case 107: // 1.39
        {
            ...
            DrawPanelText(panel, "2) [Gameplay] FF2 now automagically detects if a boss has no valid weapon, and re-equips them (SHADoW)");
        }
        case 106: // 1.38
        {
...
stock void LoadPrefsCookie(int client)
{
...
EquipBoss(boss)
{
    ...
    for(new i=1; ; i++)
    {
        ...
        if(KvJumpToKey(BossKV[Special[boss]], weapon))
        {
            ...
            new BossWeapon=SpawnWeapon(client, weapon, wepIdx, 101, 14, attributes, bool:KvGetNum(BossKV[Special[boss]], "show", 0));
            
            FF2_SetAmmo(client, BossWeapon, KvGetNum(BossKV[Special[boss]], "ammo", 0), KvGetNum(BossKV[Special[boss]], "clip", 0));
