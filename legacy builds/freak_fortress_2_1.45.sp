...
stock FindVersionData(Handle:panel, versionIndex)
{
    switch(versionIndex)
    {
        case 119: // 1.46
        {
            DrawPanelText(panel, "1) [Configs] Added ID3 tag support and manual tagging of boss themes (SHADoW)");
        }
        case 118: // 1.45
        {
...
PlayBGM(client, String:music[], Float:time, bool:loop=true, char[] name="", char[] artist="")
{
    ...
    CPrintToChat(client, "%t", "track_info", artist, name);
