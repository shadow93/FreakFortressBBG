		...
		if (IsBoss(client))
		{
			...
			if (CheckRoundState() <= 0)
			{
				...
				{	
					...
					CPrintToChat(Boss[0], "{olive}[FF2]{default} Surprise! You're on NOW!");
				}
			}
			CPrintToChatAll("{olive}[FF2]{default} %t", "ff2_boss_disconnected");
		}
